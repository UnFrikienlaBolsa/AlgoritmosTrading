...
def SendMail(tituloCorreo, html):
    toaddrs  = ['rubenglezant@gmail.com','ruben_gonzalez@iecisa.com']
...
if (total>0):
    ...
    SendMail('INVERTIR '+indice,correo)
else:
    # Enviamos el correo electronico
    SendMail('KO - Prueba de funcionamiento',''+indice+' ultimo dia cotizacion: '+ultimoDiaCotizacion+' valor: '+str(cierreEvaluar))
